...
namespace Practico_ProgramacionIII
{
    public class Program05
    {
        ...
        internal static void Ejercicio2 ()
        {
            ...
            Console.ForegroundColor = Globales.colorTextoMensaje;
            Console.WriteLine();
            int nota1 = Funciones.ReadInteger("Ingrese la primera nota: ", Globales.colorTextoMensaje);
            int nota2 = Funciones.ReadInteger("Ingrese la segunda nota: ", Globales.colorTextoMensaje);
            int nota3 = Funciones.ReadInteger("Ingrese la tercera nota: ", Globales.colorTextoMensaje);
            ...
            Funciones.TextoEnColor(aprueba.ToString(), colorResultado, Globales.colorTextoMensaje);
            Funciones.EsperarTeclaFinal();
        }
        ...
        internal static void Ejercicio3 ()
        {
            ...
            int numeroIngresado = Funciones.ReadInteger("Ingrese un número entero: ", Globales.colorTextoMensaje);
            
            bool estaDentroDelRango = numeroIngresado > 10 && numeroIngresado < 50;
            
            Console.WriteLine();
            Console.Write("El número está dentro del rango válido: ");
            Funciones.TextoEnColor(estaDentroDelRango.ToString(), estaDentroDelRango ? ConsoleColor.DarkGreen : ConsoleColor.DarkRed, Globales.colorTextoMensaje);
            Funciones.EsperarTeclaFinal();
        }
        ...
        internal static void Ejercicio4 ()
        {
            ...
            int edad = Funciones.ReadInteger("Ingrese su edad: ", Globales.colorTextoMensaje);
            string tieneDocumento = Funciones.ReadString("¿Tiene documento? (si/no): ", 1, 3, Globales.colorTextoMensaje, ConsoleColor.DarkCyan, false);
            ...
            Funciones.TextoEnColor(puedeIngresar.ToString(), puedeIngresar ? ConsoleColor.DarkGreen : ConsoleColor.DarkRed, Globales.colorTextoMensaje);
            Funciones.EsperarTeclaFinal();
        }
        ...
        internal static void Ejercicio5 ()
        {
            ...
            int edad = Funciones.ReadInteger("Ingrese su edad: ", Globales.colorTextoMensaje);
            string estaAcompanado = Funciones.ReadString("¿Está acompañado por un adulto? (si/no): ", 1, 3, Globales.colorTextoMensaje, ConsoleColor.DarkCyan, false);
            ...
            Funciones.TextoEnColor(puedeVerPelicula.ToString(), puedeVerPelicula ? ConsoleColor.DarkGreen : ConsoleColor.DarkRed, Globales.colorTextoMensaje);
            Funciones.EsperarTeclaFinal();
        }
