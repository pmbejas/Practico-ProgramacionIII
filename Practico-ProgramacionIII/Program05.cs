...
namespace Practico_ProgramacionIII
{
    public class Program05
    {
        internal static void Ejercicio1 ()
        {
            ...
            string userIngresado = Funciones.ReadString("Usuario: ", 1, 25, VariablesGlobales.colorTextoMensaje, ConsoleColor.DarkCyan, false);
            Console.SetCursorPosition(6, 21);
            string userPasswordIngresado = Funciones.ReadPassword("Contraseña: ", VariablesGlobales.colorTextoMensaje, ConsoleColor.DarkCyan);
        ...
        internal static void Ejercicio2 ()
        {
            ...
            Console.ForegroundColor = VariablesGlobales.colorTextoMensaje;
            Console.WriteLine();
            int nota1 = Funciones.ReadInteger("Ingrese la primera nota: ", VariablesGlobales.colorTextoMensaje);
            int nota2 = Funciones.ReadInteger("Ingrese la segunda nota: ", VariablesGlobales.colorTextoMensaje);
            int nota3 = Funciones.ReadInteger("Ingrese la tercera nota: ", VariablesGlobales.colorTextoMensaje);
            ...
            Funciones.TextoEnColor(aprueba.ToString(), colorResultado, VariablesGlobales.colorTextoMensaje);
            Funciones.EsperarTeclaFinal();
        }
        ...
        internal static void Ejercicio3 ()
        {
            ...
            int numeroIngresado = Funciones.ReadInteger("Ingrese un número entero: ", VariablesGlobales.colorTextoMensaje);
            
            bool estaDentroDelRango = numeroIngresado > 10 && numeroIngresado < 50;
            
            Console.WriteLine();
            Console.Write("El número está dentro del rango válido: ");
            Funciones.TextoEnColor(estaDentroDelRango.ToString(), estaDentroDelRango ? ConsoleColor.DarkGreen : ConsoleColor.DarkRed, VariablesGlobales.colorTextoMensaje);
            Funciones.EsperarTeclaFinal();
        }
        ...
        internal static void Ejercicio4 ()
        {
            ...
            int edad = Funciones.ReadInteger("Ingrese su edad: ", VariablesGlobales.colorTextoMensaje);
            string tieneDocumento = Funciones.ReadString("¿Tiene documento? (si/no): ", 1, 3, VariablesGlobales.colorTextoMensaje, ConsoleColor.DarkCyan, false);
            ...
            Funciones.TextoEnColor(puedeIngresar.ToString(), puedeIngresar ? ConsoleColor.DarkGreen : ConsoleColor.DarkRed, VariablesGlobales.colorTextoMensaje);
            Funciones.EsperarTeclaFinal();
        }
        ...
        internal static void Ejercicio5 ()
        {
            ...
            int edad = Funciones.ReadInteger("Ingrese su edad: ", VariablesGlobales.colorTextoMensaje);
            string estaAcompanado = Funciones.ReadString("¿Está acompañado por un adulto? (si/no): ", 1, 3, VariablesGlobales.colorTextoMensaje, ConsoleColor.DarkCyan, false);
            ...
            Funciones.TextoEnColor(puedeVerPelicula.ToString(), puedeVerPelicula ? ConsoleColor.DarkGreen : ConsoleColor.DarkRed, VariablesGlobales.colorTextoMensaje);
            Funciones.EsperarTeclaFinal();
        }
